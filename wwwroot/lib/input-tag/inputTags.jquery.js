(function($) {
  ...
  $.fn.inputTags.defaults = {
    ...
    errors: {
      empty: 'Bạn không thể gán một thẻ trống mà không có nghĩa.',
      minLength: 'Thẻ có quá ít ký tự.',
      maxLength: 'Thẻ có quá nhiều ký tự.',
      max: 'Bạn đã gán quá nhiều thẻ cho bài viết.',
      exists: 'Thẻ này đã được gán cho bài, bạn hãy chọn thẻ khác.',
      autocomplete_only: 'Bạn chỉ được chọn thẻ trong các thẻ gợi ý.',
      timeout: 8000
    }
  };
